...
#SBATCH --time=48:00:00                                    # time allocation, which has the format (D-HH:MM), here set t\
o 1 hour
#SBATCH --mem=120GB                                         # memory pool for all cores (here set to 32 GB)
...
--CPU 32 --trimmomatic --max_memory 120G --normalize_reads
